...
function () {
	...
	// For premium version.
	// Translators: JSON Object format to freemius override_i18n. Example for '{"yee-haw": "Yee-haw"}'. See https://github.com/Freemius/wordpress-sdk/blob/master/includes/i18n.php .
	...
	__( 'No warning-level pages were found in last week\'s breakaway data.', 'aurora-heatmap' );
